...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
		...
		$query = "SELECT * from anime,category where category.category_id=anime.category_id and category.category_id=$id";
...
<div class="col">
  ...
  <div class="card-body">
    ...
    $id = $row['id'];
     ...
     ?>
    <a href="<?php echo $row['link1'] ?>" class="btn btn-" style="background-color:#726297; color: #fff;">Watch Now</a>
  </div>
</div>
</div>
